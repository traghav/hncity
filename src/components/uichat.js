			...
			<section id="one">
				...
				<h1>{this.props.city}</h1>
						...
						<div class="7u 12u$(small)">
							...
							<h4>I'd suggest you use the chat to decide where move the discussion to some place better suited for collaborating. </h4>
							<h4>Maybe leave breadcrumbs for other organizers to catch up with you fellows</h4>
							<h4>Could be a Whatsapp group or a Telegram Channel, to each city their own! </h4>
